...
\newskip\grenabcinterelementspace

% larger space between elements in ancient notation
\newskip\grenabclargerspace
...
\def\greadaptconfvalues{%
  ...
  \greadaptoneconfvalue{\grenabcinterelementspace}%
  \greadaptoneconfvalue{\grenabclargerspace}%
...
\def\changedimenfactor#1#2{%
  ...
  \grechangeonedimenfactor{\grenabcinterelementspace}{#1}{#2}%
  \grechangeonedimenfactor{\grenabclargerspace}{#1}{#2}%
