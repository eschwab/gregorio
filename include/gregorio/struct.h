...
// src/struct-utils.c for further reading.
  ...
  void gregorio_add_special_as_glyph (gregorio_glyph **current_glyph, char type,
...
#define SCHEME_DEFAULT SCHEME_LATINE
  ...
  void gregorio_insert_character (gregorio_character *current_character,
                                  grewchar wcharacter, unsigned int style,
                                  unsigned int type);
